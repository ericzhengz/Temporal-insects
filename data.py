...
class IIMinsects202(iData):
    def __init__(self, args):
        ...
        # 加载meta.json并构建类别映射
        with open("D:/IL_IIM/data/meta.json", "r", encoding="utf-8") as json_file:
            self.meta = json.load(json_file)

        # 使用meta.json中的类别编号作为class_order
        self.class_order = list(self.meta.keys())  # 将类别编号作为class_order
    ...
    def download_data(self):
        train_dir = r"D:/IL_IIM/data/train/"
        test_dir = r"D:/IL_IIM/data/test"
